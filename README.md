...
1. **Exploratory Data Analysis (EDA)** (`eda.ipynb`):
   ...
   |--------------------------------------|-----------------------|-------------------|--------------------------------------|-----------------------------------------------------------------------------|
   | Publisher Choice Has Limited Impact on CPA Across Top 10 Platforms | 1.5092               | 0.1405            | No significant difference in CPA between publishers | Average CPA does not significantly differ among top 10 publishers; choosing one is unlikely to drastically reduce costs per application. |
   | Industry Type Does Not Significantly Affect CPA | 0.5120               | 0.8665            | No significant difference in CPA between industries | Average CPA is similar across industries (p-value = 0.87); no industry consistently drives higher/lower costs. |
   | CPA is Consistent Across Customers   | 0.8001               | 0.7392            | No significant difference in CPA between customers | Average CPA does not differ significantly between customers (p-value = 0.74); no customer drives higher/lower costs. |
   | CPA Varies Significantly Across Categories | 1.6100            | 0.0229            | Significant difference in CPA between categories | CPA differs significantly between categories (p-value = 0.023); some categories are more cost-efficient. |
   | Day of Week Has Minimal Impact on CPA| 1.3721               | 0.2231            | No significant difference in CPA between days      | Average CPA does not vary significantly across days (p-value = 0.22); no day yields lower/higher costs. |
   | CPA Remains Stable Across Months     | 1.0830               | 0.3683            | No significant difference in CPA between months     | Average CPA shows no significant variation across months (p-value = 0.37); no month drives costs. |
   | CPC Shows No Significant Difference Across Categories | 1.3918 | 0.0836            | No significant difference in CPC across categories  | Average CPC varies slightly by category but not significantly (p-value = 0.08); no category consistently lowers/higher CPC. |
